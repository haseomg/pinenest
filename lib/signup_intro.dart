          ...
          IconButton(
            ...
            onPressed: () async {
              ...
              Navigator.pushReplacement(
                context,
                MaterialPageRoute(
                  builder: (context) => Dashboard(userType: 'guest', username: username),
                ),
              );
            },
          ),
      ...
      body: SingleChildScrollView( // 스크롤 가능하도록 수정
        ...
        child: Column(
          ...
          children: [
            ...
            const Padding(
              padding: EdgeInsets.only(left: 8.0), // 왼쪽에 여백 추가
              child: Text(
                '안녕하세요!\n박스 만드는 사람들입니다',
                style: TextStyle(
                  fontSize: 26,
            ...
            MouseRegion(
              ...
              child: Container(
                padding: const EdgeInsets.all(16), // 내부 패딩을 16으로 설정
                ...
                child: Column(
                  ...
                  children: [
                    ...
                    const SizedBox(height: 8), // 고객으로 가입 텍스트와 설명 텍스트 사이의 여백
